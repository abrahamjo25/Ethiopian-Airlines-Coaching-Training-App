        ...
        <>
            ...
            <div className="px-5 min-h-screen flex justify-content-center align-items-center">
                <div className="z-1 text-center">
                    <div className="text-900 font-bold text-6xl">Access Denied!</div>
                    <p className="line-height-3 mt-0 mb-5  text-xl font-medium text-3xl" style={{ color: "#DC143C" }}>
                        You need to Log in
                    </p>
                    <button className="p-button-rounded p-button-success" onClick={goHome}>
                        Login
                    </button>
                </div>
            </div>
...
Unauthorized.getLayout = function getLayout(page) {
    return (
        <React.Fragment>
            {page}
            {/* <AppConfig minimal /> */}
