...
export const AnnualPlanReport = () => {
    ...
    useEffect(() => {
        ...
        fetchData()
            .then((data) => {
                setAssessment(data?.filter((key) => key.annualplanStatus !== ""));
            })
            .catch((error) => {
                // Handle any errors
            })
    ...
    const statusTemplate = (data) => {
        return <span className={"customer-badge " + data?.annualplanStatus}>{data?.annualplanStatus}</span>;
    };
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        >
                            ...
                            <Column field="annualplanStatus" header="Status" body={statusTemplate}></Column>
                        </DataTable>
                    </div>
                </div>
            </div>
