...
export const InterimAssessment = () => {
    ...
    useEffect(() => {
        ...
        fetchData()
            .then((data) => {
                setAssessment(data?.filter((key) => key.interimStatus !== ""));
            })
            .catch((error) => {
                // Handle any errors
            })
    ...
    const statusTemplate = (data) => {
        return <span className={"customer-badge " + data?.interimStatus}>{data?.interimStatus}</span>;
    };
        ...
        <>
            <div className="flex flex-column md:flex-row md:align-items-start md:justify-content-between mb-3">
                <div className="text-900 text-xl font-semibold mb-3 md:mb-0" style={{ fontFamily: "timesNewRoman" }}>
                    <i>Interim assessment report detail</i>
                </div>
                ...
                <div className="col-12">
                    <div className="card">
                        ...
                        >
                            ...
                            <Column field="interimStatus" header="Status" body={statusTemplate}></Column>
                        </DataTable>
                    </div>
                </div>
            </div>
